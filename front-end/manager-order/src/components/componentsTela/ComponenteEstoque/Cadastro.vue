    ...
    <div class="container-cadastro">
        ...
        <div class="body-cadastro" >
            <div id="app">
                ...
                <div class="row-form">
                    <input type="number" id="totalProduto" v-model="totalProduto" name="totalProduto" placeholder="0 || > 0">
                </div>
...
export default {
    ...
    methods:{
        checkForm(){
            ...
            EstoqueService.save(form, this.idUsuario).then(resposta => {
                this.nome = null;
                this.totalProduto = null;
